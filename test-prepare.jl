...
run(`cmake \
     ...
     -DCMAKE_SHARED_LINKER_FLAGS="-L$(ENV["POLYMAKE_DEPS_TREE"])/deps/Perl_jll/lib -Wl,-rpath,$(ENV["POLYMAKE_DEPS_TREE"])/deps/Perl_jll/lib" \
     -DCMAKE_EXE_LINKER_FLAGS="-L$(ENV["POLYMAKE_DEPS_TREE"])/deps/Perl_jll/lib -Wl,-rpath,$(ENV["POLYMAKE_DEPS_TREE"])/deps/Perl_jll/lib" \
