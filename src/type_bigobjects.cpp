...
void add_bigobject(jlcxx::Module& jlpolymake)
{
    ...
    jlpolymake.add_type<pm::perl::BigObject>("BigObject")
        ...
        .method("_get_attachment", [](const pm::perl::BigObject& p, const std::string& s) {
    ...
    jlpolymake.method("to_bool", [](const pm::perl::PropertyValue& p) {
        return static_cast<bool>(p);
    });
    jlpolymake.method("to_int", [](const pm::perl::PropertyValue& p) {
        return static_cast<pm::Int>(p);
    });
    jlpolymake.method("to_double", [](const pm::perl::PropertyValue& p) {
        return static_cast<double>(p);
    });
    jlpolymake.method("to_string", [](const pm::perl::PropertyValue& p) {
    ...
    jlpolymake.method("getname", [](const pm::perl::BigObject& p){
        return static_cast<std::string>(p.name());
    });
